...
private:
  ...
  static void extractPrefix(const std::string &line, IRCMessage &msg,
                            size_t &pos);
  static void extractCommand(const std::string &line, IRCMessage &msg,
                             size_t &pos);
  static void extractParam(const std::string &line, IRCMessage &msg,
                           size_t &pos);
};
#endif // PARSER_HPP
